...
public class SportActivity extends AppCompatActivity {
        ...
        choice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(choice1.getText() == mAnswers) {
                    ...
                    score.setText ("Score: " + mScore);
                    updateQuestions(r.nextInt(mQuestionsLenght));
                    Toast.makeText(SportActivity.this, "Correct", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(SportActivity.this, "Incorrect", Toast.LENGTH_SHORT).show();
                }
        ...
        choice4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(choice4.getText() == mAnswers) {
                    ...
                    updateQuestions(r.nextInt(mQuestionsLenght));
                    Toast.makeText(SportActivity.this, "Correct", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(SportActivity.this, HighScoreActivity.class);
    ...
    private void gameOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SportActivity.this);
        alertDialogBuilder
