...
public class HistoryActivity extends AppCompatActivity {
    ...
    private question1 mQuestions = new question1();
        ...
        choice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(choice1.getText() == mAnswers) {
                    ...
                    Toast.makeText(HistoryActivity.this, "Incorrect", Toast.LENGTH_SHORT).show();
        ...
        choice4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(choice4.getText() == mAnswers) {
                    ...
                    score.setText ("Score: " + mScore);
                    updateQuestions(r.nextInt(mQuestionsLenght));
                    System.out.println(mScore + " is your score");
                    Toast.makeText(HistoryActivity.this, "Correct", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(HistoryActivity.this, HighScoreActivity.class);
